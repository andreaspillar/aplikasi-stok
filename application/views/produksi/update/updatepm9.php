<div class="container">
  <div class="container-fluid">
    <form class="updatepm9" method="post" >
      <?php foreach ($updatePiC as $uP): ?>
        <div class="form-group" hidden>
          <label for="idbarang">Nama Barang</label>
          <input name="detailb" type="text" class="form-control" value="<?php echo $uP->id_detail ?>" readonly hidden>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group input-group-prepend">
            ...
            <input type="number" min="0" step="500" class="form-control" id="inputharga" name="inputharga" value="<?php echo $uP->harga_barang ?>" required><br>
          </div>
        </div>
        <div class="form-group">
