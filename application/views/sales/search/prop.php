          ...
          <tbody>
            ...
            <?php foreach ($listok as $lS): ?>
              <tr>
                ...
                <td>
                  <?php if ($lS->sisa_stok == 0): ?>
                    <a class="btn btn-sm btn-gradient-danger text-white btnIND" name="button" data-href="<?php echo site_url('sales/inden/'.$lS->id_detail) ?>">Inden Sekarang</a>
                  <?php else: ?>
                    <a class="btn btn-sm btn-gradient-success text-white btnBUY" name="button" data-href="<?php echo site_url('sales/buy/'.$lS->id_detail) ?>">Beli Sekarang</a>
                  <?php endif; ?>
                </td>
              </tr>
            <?php endforeach; ?>
