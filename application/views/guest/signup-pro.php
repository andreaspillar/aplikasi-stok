        ...
        <div class="row w-100">
          <div class="col-lg-5 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h6 class="font-weight-light">Daftar sebagai orang Produksi</h6>
              <form class="pt-2" method="post" action="<?php echo site_url('login/produksichallenge') ?>">
                ...
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="retypepas" name="retypepas" placeholder="Ketik Ulang Kata Sandi" required>
                </div>
                <div class="mt-3">
