    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <button class="btn btn-rounded btn-icon btn-sm btn-outline-info btnInsert text-info" data-href="<?php echo site_url('produksi/insert5') ?>"> <i class="mdi mdi-plus"></i></button>
              </ol>
            </nav>
          </div>
          <div class="row">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($listok as $lS): ?>
                          <tr>
                            ...
                            <td class="aksibtn"><a class="btn btn-block btn-sm btn-gradient-warning text-white btnUpdate" name="button" data-href="<?php echo site_url('produksi/update5/'.$lS->id_detail) ?>">Ganti</a>
        ...
        function printStock() {
            ...
            var pageTitle = 'Stock PM 5 - PT Pura Barutama',
