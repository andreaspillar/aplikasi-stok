          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <button class="btn btn-rounded btn-icon btn-sm btn-outline-info btnInsert text-info" data-href="<?php echo site_url('produksi/insert6') ?>"> <i class="mdi mdi-plus"></i></button>
              </ol>
            </nav>
          </div>
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <p class="card-description">
                    List Dari Produksi PM6 Unit PM569
                  </p>
                      ...
                      <tbody>
                        ...
                        <?php foreach ($listok as $lS): ?>
                          <tr>
                            ...
                            <td><?php echo $lS->nama_barang.' '.$lS->nama_warna; ?></td>
                            ...
                            <td class="aksibtn"><a class="btn btn-block btn-sm btn-gradient-warning text-white btnUpdate" name="button" data-href="<?php echo site_url('produksi/update6/'.$lS->id_detail) ?>">Ganti</a>
